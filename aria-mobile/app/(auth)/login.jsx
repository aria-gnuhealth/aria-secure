...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 42, fontWeight: "bold", color: "#1a73e8", textAlign: "center", marginBottom: 8 },
  ...
  button: { backgroundColor: "#1a73e8", borderRadius: 10, padding: 16, alignItems: "center", marginBottom: 12 },
  buttonText: { color: "#fff", fontSize: 16, fontWeight: "600" },
  link: { color: "#1a73e8", textAlign: "center", fontSize: 14, marginTop: 12 },
  resendLink: { color: "#888", textAlign: "center", fontSize: 13, marginTop: 8 },
});
