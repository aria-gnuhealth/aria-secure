...
export default function TrashScreen() {
      ...
      { text: "Annuler", style: "cancel" },
      {
        text: "Restaurer", onPress: async () => {
          try {
            ...
            Alert.alert("✅ Restaurée", "Radiographie restaurée avec succès !");
            fetchTrash();
          } catch (e) {
  ...
  Alert.alert(
    ...
    "Cette action est irréversible. L’image sera définitivement supprimée (fichier + base).",
    [
      { text: "Annuler", style: "cancel" },
      {
        ...
        onPress: async () => {
          try {
            ...
            fetchTrash();
            Alert.alert("✅ Supprimée", "L’image a été définitivement effacée.");
          } catch (e) {
            console.log(e);
    ...
    >
      ...
      <View style={styles.infoCard}>
        <Text style={styles.infoText}>
          🕐 Les radiographies supprimées sont automatiquement effacées après <Text style={{ fontWeight: "700" }}>7 jours</Text>.
        </Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  infoCard: {
    backgroundColor: "#FFF8E1", marginHorizontal: 16, marginTop: 16,
